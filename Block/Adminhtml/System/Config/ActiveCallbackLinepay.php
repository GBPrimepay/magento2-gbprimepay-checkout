...
class ActiveCallbackLinepay extends FormField
{
     ...
     *
     * @return \GBPrimePay\Checkout\Block\Adminhtml\System\Config\ActiveCallbackLinepay
     */
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if ($check) {
            $buttonLabel = "GBPrimePay Rabbit Line Pay : Active";
            $class = "callback-actived";
        } else {
            $buttonLabel = "GBPrimePay Rabbit Line Pay : Inactive";
            $class = "";
        }
        ...
        $this->addData(
            [
                ...
                'html_id' => "active_callback_linepay_transaction_button",
                'ajax_url' => $this->_urlBuilder->getUrl('gbprimepay/system_config/activeCallbackLinepay'),
            ]
        );
    ...
    public function checkEnable()
    {
        try {
          if ($this->_config->getActiveLinepay()) {
            $callbackUrl = $this->storeManager->getStore()->getBaseUrl() . 'gbprimepay/checkout/callbacklinepay';
