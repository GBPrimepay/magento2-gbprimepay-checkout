...
class GBPrimePayCheckout extends \Magento\Payment\Model\Method\AbstractMethod
{
    const CODE = 'gbprimepay_checkout';
    ...
    public function __construct(
        ...
        \GBPrimePay\Checkout\Model\PurchaseFactory $purchaseFactory,
    ...
    if (count($filterpurchase) > 0) {
        foreach ($filterpurchase as $pur) {
            if ($pur['magento_customer_id'] === $purchase['id_customer']) {
                ...
                $purchaseModel->setpostload($purchase['postload']);
