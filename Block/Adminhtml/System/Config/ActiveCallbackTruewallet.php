...
class ActiveCallbackTruewallet extends FormField
{
     ...
     *
     * @return \GBPrimePay\Checkout\Block\Adminhtml\System\Config\ActiveCallbackTruewallet
     */
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if ($check) {
            $buttonLabel = "GBPrimePay TrueMoney Wallet : Active";
            $class = "callback-actived";
        } else {
            $buttonLabel = "GBPrimePay TrueMoney Wallet : Inactive";
            $class = "";
        }
        ...
        $this->addData(
            [
                ...
                'html_id' => "active_callback_truewallet_transaction_button",
                'ajax_url' => $this->_urlBuilder->getUrl('gbprimepay/system_config/activeCallbackTruewallet'),
            ]
        );
    ...
    public function checkEnable()
    {
        try {
          if ($this->_config->getActiveTruewallet()) {
            $callbackUrl = $this->storeManager->getStore()->getBaseUrl() . 'gbprimepay/checkout/callbacktruewallet';
