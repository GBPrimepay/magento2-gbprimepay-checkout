...
namespace GBPrimePay\Checkout\Controller\Adminhtml\System\Config;

use GBPrimePay\Checkout\Logger\Logger;
use Magento\Backend\App\Action;
use Magento\Backend\App\Action\Context;
use Magento\Framework\Controller\Result\JsonFactory;
use GBPrimePay\Checkout\Helper\Constant;

class ActiveCallbackTruewallet extends Action
{
    /**
     * @var JsonFactory
     */
            ...
            switch ($check) {
                case 0:
                    return $result->setData([
                        'success' => true,
                        'error' => false,
                        'message' => "Actived, TrueMoney Wallet is already set"
                    ]);
                    break;
                case 2:
