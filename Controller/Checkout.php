...
namespace GBPrimePay\Checkout\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \GBPrimePay\Checkout\Controller\Checkout\CsrfValidator $CsrfValidator,
        \GBPrimePay\Checkout\Model\GBPrimePayCheckout $gbprimepayCheckout,
        \GBPrimePay\Checkout\Model\GBPrimePayDirect $gbprimepayDirect,
        \GBPrimePay\Checkout\Model\GBPrimePayInstallment $gbprimepayInstallment,
        ...
        $this->gbprimepayCheckout = $gbprimepayCheckout;
    ...
    public function getStoreLocale() {        
        return $this->storeLocale->getLocale();
    }
